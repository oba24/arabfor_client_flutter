        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(50.h), color: context.theme.primaryColor),
              child: Column(
                children: [
                  Text(
                    _event.type == TYPE.register ? LocaleKeys.activate_the_account.tr() : LocaleKeys.Validation_code.tr(),
                    style: context.textTheme.headline1,
                  ),
                  Text(
                    _event.type == TYPE.register
                        ? LocaleKeys.A_message_was_sent_on_your_mobile_number_to_activate_the_account.tr()
                        : LocaleKeys.A_message_was_sent_to_your_mobile_number_to_check_the_account.tr(),
                  ...
                  Text(
                    '+${_event.mobile.text} ',
                    style: context.textTheme.subtitle1!.copyWith(color: "#43290A".toColor),
                    textAlign: TextAlign.center,
                      ...
                      listener: (context, state) {
                        if (state is DoneActiveCodeState) {
                          if (_event.type == TYPE.resetPassword) {
                            push(ResetPasswordView(phone: _event.mobile.text, code: _event.activeCode.text));
