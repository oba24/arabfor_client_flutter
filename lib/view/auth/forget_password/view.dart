        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text(LocaleKeys.Account_Confirmation.tr(), style: context.textTheme.headline1),
                  ...
                  BlocConsumer(
                      ...
                      listener: (context, state) {
                        if (state is DoneForgetPasswordState) {
                          push(ActiveCodeView(event: StartActiveCodeEvent(mobile: _event.mobile, type: TYPE.resetPassword)));
