...
class OrderDatum {
  ...
  String get hexColor =>
      ...
      "";
  String get payTypeTr =>
      {
        "cash": LocaleKeys.cash.tr(),
        "credit": LocaleKeys.credit.tr(),
        "wallet": LocaleKeys.wallet.tr()
      }[payType] ??
      "";
  String get statusTr =>
      {
  ...
  factory OrderDatum.fromJson(Map<String, dynamic> json) => OrderDatum(
        ...
        status: json["status"] ?? "",
        orderProducts: List<OrderProductsDatum>.from(
            (json["order_products"] ?? [])
                .map((x) => OrderProductsDatum.fromJson(x))),
        date: json["date"] ?? "",
        ...
        time: json["time"] ?? "",
        provider: ClientDatum.fromJson(json["provider"] ?? {}),
...
class OrderProductsDatum {
  ...
  factory OrderProductsDatum.fromJson(Map<String, dynamic> json) =>
      OrderProductsDatum(
        id: json["id"] ?? 0,
...
class ProductOrderDatum {
  ...
  double get finalPrice =>
      priceAfterDiscount > 0 ? priceAfterDiscount : priceBeforeDiscount;

  factory ProductOrderDatum.fromJson(Map<String, dynamic> json) =>
      ProductOrderDatum(
        id: json["id"] ?? 0,
        name: json["name"] ?? "",
